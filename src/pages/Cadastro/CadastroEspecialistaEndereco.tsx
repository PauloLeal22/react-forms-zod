...
const CadastroEspecialistaEndereco = () => {
  ...
  const { aoSubmeter, errors, handleSubmit, register } = useCep();  
      ...
      <Form onSubmit={handleSubmit(aoSubmeter)}>
        <>
          ...
          <UploadLabel htmlFor="campo-upload">
            ...
            <UploadInput accept="image/*" id="campo-upload" type="file" {...register('avatar')} />
          </UploadLabel>
        ...
        <FormContainer>
          <Fieldset>
            ...
            <Input id="campo-numero-rua" placeholder="Ex: 1440" type="text" $error={!!errors.endereco?.numero} {...register('endereco.numero')} />
            { errors?.endereco?.numero && <ErrorMessage>{ errors?.endereco?.numero?.message }</ErrorMessage> }
          </Fieldset>
          <Fieldset>
            <Label htmlFor="campo-bairro">Bairro</Label>
            <Input id="campo-bairro" placeholder="Vila Mariana" type="text" $error={!!errors.endereco?.bairro} {...register('endereco.bairro')} />
